...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gray-900/50 py-16 px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800/50 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Descubre los mejores bares y restaurantes cerca de tu ubicación
                actual.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Happy Hours</h3>
              <p className="text-gray-400">
                No te pierdas las mejores ofertas y happy hours en tu zona.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg">
              ...
              <p className="text-gray-400">
                Reserva mesas en tus lugares favoritos con solo unos clics.
              </p>
            </div>
          </div>
        </div>
